...
export const getMoviesPopular = () => {
  return get(`${axios.defaults.baseURL}/movie/popular${API_KEY}&include_adult=false`);
};

export const getTopMovies = () => {
  return get(`${axios.defaults.baseURL}/movie/top_rated${API_KEY}&include_adult=false`);
};

export const getTheaterMovies = () => {
  return get(`${axios.defaults.baseURL}/movie/now_playing${API_KEY}&include_adult=false`);
};
...
export const getSingleActor = ({ queryKey }) => {
  ...
  return get(`${axios.defaults.baseURL}/person/${id}${API_KEY}&append_to_response=movie_credits&include_adult=false`);
};

export const getGenres = ({ queryKey }) => {
  return get(`${axios.defaults.baseURL}/genre/movie/list${API_KEY}&include_adult=false`);
};
